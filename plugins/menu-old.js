...
`;
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/SALEEM-BUG/SALEEM-MD/raw/refs/heads/main/autovoice/menunew.m4a' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: {
                mentionedJid: [m.sender],
...
╰──────────────┈⊷`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://i.postimg.cc/8CQp6Z15/IMG-20250904-WA0334.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
